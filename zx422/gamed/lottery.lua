...
------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20284SelectNumber(list, max_count) 			--- Lottery Used@200801009(苍穹光印)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType22126SelectNumber(list, max_count)			--- Lottery Used@20100219(云雪绘卷)
	local NumList={1,2,3,4}
	local NumChance={126,311,300,263}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType22127SelectNumber(list, max_count)			--- Lottery Used@20100219(炎光匣龙)
	local NumList={1,2,3,4}
	local NumChance={126,311,300,263}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23144SelectNumber(list, max_count)			--- Lottery Used@20100219(神章云锦)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23162SelectNumber(list, max_count)			--- Lottery Used@20100219(天骥金鉴)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23212SelectNumber(list, max_count)			--- Lottery Used@20100219(圣龙玉髓)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19240SelectNumber(list, max_count)			--- Lottery Used@20100219(神龙秘籍)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType25305SelectNumber(list, max_count)			--- Lottery Used@20100219(天竺牙雕)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType25417SelectNumber(list, max_count)			--- Lottery Used@20100219(血月镇木)
	local NumList={1,2,3,4}
	local NumChance={20,20,30,30}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
...
function LotteryType22127Cashing(cur_list)	---(炎光匣龙)
	...
	Out_Prize[4][13900]=25		---虎魄玄冰
	Out_Prize[4][13901]=100		---龟灵玄冰
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23144Cashing(cur_list)		---(神章云锦)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
function LotteryType23162Cashing(cur_list)		---(天骥金鉴)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	elseif nowcurlist[fmax_count]=="22" then
		return 4,0,8079,2,0,0
	elseif nowcurlist[fmax_count]=="20" then
		return 2,0,11678,1,0,0
	elseif nowcurlist[fmax_count]=="40" then
		return 4,0,8079,2,0,0
	elseif nowcurlist[fmax_count]=="20" then
		return 2,0,11677,1,0,0
	elseif nowcurlist[fmax_count]=="30" then
		return 3,0,18794,3,0,0
	elseif nowcurlist[fmax_count]=="20" then
...
-------------------------------------------------------------------------------------------------------------
function LotteryType23212Cashing(cur_list)		---(圣龙玉髓)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19240Cashing(cur_list)		---(神龙秘籍)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
