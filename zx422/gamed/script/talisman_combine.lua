...
function ZLuaTalismanEnchantSkillCid()
	local TalismanEnchantSkillCid={}
		...
		TalismanEnchantSkillCid[23882]={prof=9,enchantskilltype=0,enchantskillid=337,maxsameskillcol=1} ---//格数重随
		...
		TalismanEnchantSkillCid[23883]={prof=9,enchantskilltype=4,enchantskillid=337,maxsameskillcol=1} ---//属性可见
