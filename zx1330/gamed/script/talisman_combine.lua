...
---	 	output:UpdateData(0,dataIndex["tmpl_id"], 0)
	 	...
	 	output:UpdateData(0,dataIndex["grow_hp"], 88.59999694824)
	 	output:UpdateData(0,dataIndex["grow_mp"], 63)
	 	output:UpdateData(0,dataIndex["grow_attack_rate"], 0)
	 	output:UpdateData(0,dataIndex["grow_damage_low"], 12)
	 	output:UpdateData(0,dataIndex["grow_damage_high"], 23.410000038147)
	 	output:UpdateData(0,dataIndex["grow_dodge"], 0)
	 	output:UpdateData(0,dataIndex["grow_defense"], 0)
	 	output:UpdateData(0,dataIndex["grow_resis_stun"], 3.8099999427795)
	 	output:UpdateData(0,dataIndex["grow_resis_sleep"], 3.0099999427795)
	 	output:UpdateData(0,dataIndex["grow_resis_silence"], 3.3099999427795)
	 	output:UpdateData(0,dataIndex["grow_resis_weakness"], 4.8099999427795)
	 	output:UpdateData(0,dataIndex["grow_resis_enlace"], 4.1099999427795)

	 	output:UpdateData(0,dataIndex["addon_1_learn_level"], 11)
	 	output:UpdateData(0,dataIndex["addon_1_id"], 393)
	 	output:UpdateData(0,dataIndex["addon_2_learn_level"], 28)
	 	output:UpdateData(0,dataIndex["addon_2_id"], 899)
	 	output:UpdateData(0,dataIndex["addon_3_learn_level"], 20)
	 	output:UpdateData(0,dataIndex["addon_3_id"], 398)
	 	output:UpdateData(0,dataIndex["addon_4_learn_level"], 10)
	 	output:UpdateData(0,dataIndex["addon_4_id"], 389)
	 	output:UpdateData(0,dataIndex["addon_5_learn_level"], 18)
	 	output:UpdateData(0,dataIndex["addon_5_id"], 396)
	 	output:UpdateData(0,dataIndex["addon_6_learn_level"], 28)
	 	output:UpdateData(0,dataIndex["addon_6_id"], 898)
	 	output:UpdateData(0,dataIndex["addon_7_learn_level"], 0)
	 	output:UpdateData(0,dataIndex["addon_7_id"], 0)
	 	output:UpdateData(0,dataIndex["addon_8_learn_level"], 0)
	 	output:UpdateData(0,dataIndex["addon_8_id"], 0)
	 	...
	 	output:UpdateData(0,dataIndex["birth_min3"], 2)
	 	output:UpdateData(0,dataIndex["quality"], 2)
	 	output:UpdateData(0,dataIndex["speciality"], 28)
	 	output:UpdateData(0,dataIndex["buff_type"], 0)
	 	output:UpdateData(0,dataIndex["ext_id"], 0)
	 	output:UpdateData(0,dataIndex["skill_visible"], 1)
	 	output:UpdateData(0,dataIndex["combine_times"], 639)
	 	...
	 	output:UpdateData(0,dataIndex["hp_rise"], 0)
	 	output:UpdateData(0,dataIndex["mp_rise"], 0)
	 	output:UpdateData(0,dataIndex["minattack_rise"], 0)
	 	output:UpdateData(0,dataIndex["maxattack_rise"], 0)
	 	output:UpdateData(0,dataIndex["stun_rise"], 0)
	 	output:UpdateData(0,dataIndex["weakness_rise"], 0)
	 	output:UpdateData(0,dataIndex["enlace_rise"], 0)
	 	output:UpdateData(0,dataIndex["silence_rise"], 0)
	 	output:UpdateData(0,dataIndex["sleep_rise"], 0)
	 	output:UpdateData(0,dataIndex["all_rise"], 0)

	 	output:UpdateData(0,dataIndex["hp_enhance"], 3100)
	 	output:UpdateData(0,dataIndex["mp_enhance"], 0)
	 	output:UpdateData(0,dataIndex["atk_enhance"], 950)

	 	output:UpdateData(0,dataIndex["skillrefine_level"], 0)
	 	output:UpdateData(0,dataIndex["skillrefine_0"], 0)
	 	output:UpdateData(0,dataIndex["skillrefine_1"], 0)
	 	output:UpdateData(0,dataIndex["skillrefine_2"], 0)
	 	output:UpdateData(0,dataIndex["skillrefine_3"], 0)
	 	output:UpdateData(0,dataIndex["skillrefine_4"], 0)
	 	...
	 	output:UpdateData(0,dataIndex["reborncont"], 0)
