...
function LotteryType40344SelectNumber(list, max_count)			--- Lottery Used@20100527(十全界书)
	...
	local subChance = {}
	local subSum = {}
	subChance[1] = {10,70,20,70}						-- 一等奖内部相对概率
	subChance[2] = {30,40,40,40}						-- 二等奖内部相对概率
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType40344Cashing(cur_list)		---(天界圣器)
	if cur_list[1]==1 then 				--噬血珠礼包
		return 1,0,20503,1,0,0
	elseif cur_list[1]==5 then		--出价符100张
		return 1,0,35367,100,0,0
	elseif cur_list[1]==9 then		--摄魂礼包
		return 1,0,33820,1,0,0
	elseif cur_list[1]==13 then		--出价符100张
		return 1,0,35367,100,0,0

	elseif cur_list[1]==3 then		--天道
		return 2,0,10957,1,0,0
	elseif cur_list[1]==7 then		--天循
		return 2,0,6315,1,0,0
	elseif cur_list[1]==11 then		--天戍
		return 2,0,6305,1,0,0
	elseif cur_list[1]==15 then		--玉虚
		return 2,0,3463,1,0,0

	elseif cur_list[1]==4 then		--飞天神符20个
		return 3,0,8079,20,0,0
	elseif cur_list[1]==6 then		--飞天神符20个
		return 3,0,8079,20,0,0
	elseif cur_list[1]==12 then		--飞天神符20个
		return 3,0,8079,20,0,0
	elseif cur_list[1]==14 then		--飞天神符20个
		return 3,0,8079,20,0,0

	elseif cur_list[1]==2 then		--虎魄玄冰5个
		return 4,0,25307,5,0,0
	elseif cur_list[1]==8 then		--龟灵玄冰5个
		return 4,0,25306,5,0,0
	elseif cur_list[1]==10 then		--龟灵玄冰5个
		return 4,0,25306,5,0,0
	else													--虎魄玄冰5个
		return 4,0,25307,5,0,0
	end
