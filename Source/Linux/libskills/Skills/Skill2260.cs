...
namespace SKILL
{
	public class GSkill2260Stub : GSkillStub
	{
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio(1887.0f);
			victim.SetAmount(1896.0f);
			victim.SetValue(1905.0f);
			victim.SetClearcooldown(true);
			victim.SetRatio(1914.0f);
			victim.SetAmount(1920.0f);
			victim.SetValue(219.0f);
			victim.SetClearcooldown(true);
			return true;
		}
	}
	public class GSkill2260 : GSkill
	{
		public GSkill2260()
			: base(2260)
		{
	...
	public class GSkill2261Stub : GSkillStub
	{
		public GSkill2261Stub()
			: base(2261)
		{
			occupation = 129;
			maxlevel = 1;
	...
	public class GSkill2261 : GSkill
	{
		public GSkill2261()
			: base(2261)
		{
	...
	public class GSkill2262Stub : GSkillStub
	{
		public GSkill2262Stub()
			: base(2262)
		{
			occupation = 129;
			maxlevel = 1;
	...
	public class GSkill2262 : GSkill
	{
		public GSkill2262()
			: base(2262)
		{
	...
	public class GSkill2263Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				player.SetHp((player_hp * (skill_level * 0.01f)));
				player.SetPerform(1);
			}
		}
		public GSkill2263Stub()
			: base(2263)
		{
			occupation = 128;
			maxlevel = 100;
	...
	public class GSkill2263 : GSkill
	{
		public GSkill2263()
			: base(2263)
		{
	...
	public class GSkill2264Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(((500 * skill_t0 + 15100)));
			victim.SetWrap(true);
			return true;
		}
		public override bool BlessMe(GSkill skill)
	...
	public class GSkill2264 : GSkill
	{
		public GSkill2264()
			: base(2264)
		{
	...
	public class GSkill2265Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2265 : GSkill
	{
		public GSkill2265()
			: base(2265)
		{
	...
	public class GSkill2266Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((((81 * skill_level + 596)) - skill_level * (skill_level * 1.8f)) * (D2INT(skill_level * 0.05f + 0.55f)) + (((17 * skill_level) + (skill_level * (skill_level * 0.089f)) + 742.0f) * (D2INT(1.42f - skill_level * 0.05f)))));
				player.SetPerform(1);
			}
		}
		public class GState3 : GState
			...
			: base(2266)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"天音寺_骑乘_六道轮回");
			SetAction(19,"天音寺_骑乘_六道轮回");
			SetAction(20,"天音寺_骑乘_六道轮回");
			SetAction(21,"天音寺_骑乘_六道轮回");
			SetAction(22,"天音寺_骑乘_六道轮回");
			SetAction(23,"天音寺_骑乘_六道轮回");
			SetAction(24,"0");
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"0");
	...
	public class GSkill2266 : GSkill
	{
		public GSkill2266()
			: base(2266)
		{
	...
	public class GSkill2267Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetRatio((skill_t1 * 0.05f + (skill_level * 0.1f + 1.0f)));
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(15100.0f);
			victim.SetRatio((skill_level * 0.1f + 0.4f));
			victim.SetBuffid(1);
	...
	public class GSkill2267 : GSkill
	{
		public GSkill2267()
			: base(2267)
		{
	...
	public class GSkill2268Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2268 : GSkill
	{
		public GSkill2268()
			: base(2268)
		{
	...
	public class GSkill2269Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2269 : GSkill
	{
		public GSkill2269()
			: base(2269)
		{
