...
namespace SKILL
{
	public class GSkill2750Stub : GSkillStub
	{
	...
	public class GSkill2750 : GSkill
	{
		public GSkill2750()
			: base(2750)
		{
	...
	public class GSkill2751Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2751 : GSkill
	{
		public GSkill2751()
			: base(2751)
		{
	...
	public class GSkill2752Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio((skill_level * 0.1f + 1.0f));
			victim.SetBuffid(1);
			...
			victim.SetValue(500000.0f);
			victim.SetHeal(true);
			return true;
		}
	}
	public class GSkill2752 : GSkill
	{
		public GSkill2752()
			: base(2752)
		{
	...
	public class GSkill2753Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(409000.0f);
			victim.SetBuffid(-272);
			victim.SetAmount(268.80399f);
			victim.SetValue(-401.50299f);
			...
			victim.SetProbability(0.0f);
			victim.SetTime(409000.0f);
			victim.SetBuffid(-268);
			victim.SetAmount(277.13599f);
			victim.SetValue(-371.71799f);
			victim.SetMagicdoor(true);
			if ( skill_level == 3 )
			v21 = 100.0f;
			else
			victim.SetProbability(0.0f);
			victim.SetTime(409000.0f);
			victim.SetBuffid(-252);
			victim.SetAmount(269.30701f);
			victim.SetValue(-354.45901f);
			victim.SetMagicdoor(true);
			*/
			return true;
		}
	}
	public class GSkill2753 : GSkill
	{
		public GSkill2753()
			: base(2753)
		{
	...
	public class GSkill2754Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2754 : GSkill
	{
		public GSkill2754()
			: base(2754)
		{
	...
	public class GSkill2755Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio(1.0f);
			victim.SetAmount(1.0f);
			victim.SetValue(253.0f);
			victim.SetTransform(true);
			return true;
		}
	}
	public class GSkill2755 : GSkill
	{
		public GSkill2755()
			: base(2755)
		{
	...
	public class GSkill2756Stub : GSkillStub
	{
		public GSkill2756Stub()
			: base(2756)
		{
			occupation = 129;
			maxlevel = 99;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(((5000 * (skill_level / 10))));
			victim.SetRatio(((skill_level - 10 * (skill_level / 10)) * 0.2f));
			victim.SetBuffid(5);
			victim.SetIncskilldodge(true);
			return true;
		}
	}
	public class GSkill2756 : GSkill
	{
		public GSkill2756()
			: base(2756)
		{
	...
	public class GSkill2757Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(1800000.0f);
			victim.SetBuffid(1);
			victim.SetAmount(500000.0f);
			victim.SetValue(800000.0f);
	...
	public class GSkill2757 : GSkill
	{
		public GSkill2757()
			: base(2757)
		{
	...
	public class GSkill2758Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				player.SetPerform(1);
				skill.SetCrit((skill_level * 0.1f));
			}
		}
		public GSkill2758Stub()
			: base(2758)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2758 : GSkill
	{
		public GSkill2758()
			: base(2758)
		{
	...
	public class GSkill2759Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2759 : GSkill
	{
		public GSkill2759()
			: base(2759)
		{
