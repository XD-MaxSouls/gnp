...
namespace SKILL
{
	public class GSkill3810Stub : GSkillStub
	{
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((skill_level * skill_level + 570)));
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			if ( player_var1 == 2 )
			{
			if ( player_var2 - player_res1 <= 0 )
			{
			v32 = 0.0f;
			}
			else
			{
			v32 = (player_var2 - player_res1);
			}
			d = v32;
			}
			else
		...
		{
			int[] array={3490};return array[index];
		}
	...
	public class GSkill3810 : GSkill
	{
		public GSkill3810()
			: base(3810)
		{
	...
	public class GSkill3811Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3811 : GSkill
	{
		public GSkill3811()
			: base(3811)
		{
	...
	public class GSkill3812Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override int GetCooldowntime(GSkill skill)
		{
			...
			return 120000 - 8000 * skill_level;
		}
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((player_res1 + 120)));
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			/*
			if ( norm(zrand(100) / (5 * skill_level)) )
			d = 3466.0f;
			else
	...
	public class GSkill3812 : GSkill
	{
		public GSkill3812()
			: base(3812)
		{
	...
	public class GSkill3813Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			{
			d = (3 * skill_level + (player_var1 - player_res1));
			}
			victim.SetProbability(d);
			victim.SetTime(2000.0f);
			victim.SetRatio(0.0f);
	...
	public class GSkill3813 : GSkill
	{
		public GSkill3813()
			: base(3813)
		{
	...
	public class GSkill3814Stub : GSkillStub
	{
		public GSkill3814Stub()
			: base(3814)
		{
			occupation = 149;
			maxlevel = 12;
	...
	public class GSkill3814 : GSkill
	{
		public GSkill3814()
			: base(3814)
		{
	...
	public class GSkill3815Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3815 : GSkill
	{
		public GSkill3815()
			: base(3815)
		{
	...
	public class GSkill3816Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetAmount(((skill_level / 2 + 1)));
			victim.SetClearbuff(true);
			return true;
		}
	}
	public class GSkill3816 : GSkill
	{
		public GSkill3816()
			: base(3816)
		{
	...
	public class GSkill3817Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((player_var1 + 150)));
	...
	public class GSkill3817 : GSkill
	{
		public GSkill3817()
			: base(3817)
		{
	...
	public class GSkill3818Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetCrit(0.64999998f);
				skill.SetCrithurt(1.0f);
				skill.SetRatio(1.5f);
				player.SetPerform(1);
			}
		}
		public GSkill3818Stub()
			: base(3818)
		{
			occupation = 146;
			maxlevel = 1;
	...
	public class GSkill3818 : GSkill
	{
		public GSkill3818()
			: base(3818)
		{
	...
	public class GSkill3819Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3819 : GSkill
	{
		public GSkill3819()
			: base(3819)
		{
