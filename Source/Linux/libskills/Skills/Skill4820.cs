...
namespace SKILL
{
	public class GSkill4820Stub : GSkillStub
	{
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetAmount(4806.0f);
			victim.SetValue(4797.0f);
			victim.SetSetcooldown(true);
			*/
			return true;
		}
	}
	public class GSkill4820 : GSkill
	{
		public GSkill4820()
			: base(4820)
		{
	...
	public class GSkill4821Stub : GSkillStub
	{
		public GSkill4821Stub()
			: base(4821)
		{
			occupation = 106;
			maxlevel = 10;
	...
	public class GSkill4821 : GSkill
	{
		public GSkill4821()
			: base(4821)
		{
	...
	public class GSkill4822Stub : GSkillStub
	{
		public GSkill4822Stub()
			: base(4822)
		{
			occupation = 106;
			maxlevel = 10;
	...
	public class GSkill4822 : GSkill
	{
		public GSkill4822()
			: base(4822)
		{
	...
	public class GSkill4823Stub : GSkillStub
	{
		public GSkill4823Stub()
			: base(4823)
		{
			occupation = 106;
			maxlevel = 10;
	...
	public class GSkill4823 : GSkill
	{
		public GSkill4823()
			: base(4823)
		{
	...
	public class GSkill4824Stub : GSkillStub
	{
		public GSkill4824Stub()
			: base(4824)
		{
			occupation = 106;
			maxlevel = 10;
	...
	public class GSkill4824 : GSkill
	{
		public GSkill4824()
			: base(4824)
		{
	...
	public class GSkill4825Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			/*
			if ( player.GetTmplid() <= 58413
			|| (v3 = player, GNET::PlayerWrapper::GetTmplid(v3) > 58418) )
			d = 0.0f;
			else
	...
	public class GSkill4825 : GSkill
	{
		public GSkill4825()
			: base(4825)
		{
	...
	public class GSkill4826Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4826 : GSkill
	{
		public GSkill4826()
			: base(4826)
		{
	...
	public class GSkill4827Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount(1.0f);
			victim.SetValue(58565.0f);
			victim.SetSummon(true);
			return true;
		}
	}
	public class GSkill4827 : GSkill
	{
		public GSkill4827()
			: base(4827)
		{
	...
	public class GSkill4828Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue(576000.0f);
			victim.SetMpgen(true);
			return true;
		}
	}
	public class GSkill4828 : GSkill
	{
		public GSkill4828()
			: base(4828)
		{
	...
	public class GSkill4829Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4829 : GSkill
	{
		public GSkill4829()
			: base(4829)
		{
