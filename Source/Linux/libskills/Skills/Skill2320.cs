...
namespace SKILL
{
	public class GSkill2320Stub : GSkillStub
	{
			...
			: base(2320)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÊÞÉñ_Æï³Ë_·¨±¦_Å­ÊÞá¦");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill2320 : GSkill
	{
		public GSkill2320()
			: base(2320)
		{
	...
	public class GSkill2321Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2321)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÊÞÉñ_Æï³Ë_·¨±¦_Ñª·ãÇ¹");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill2321 : GSkill
	{
		public GSkill2321()
			: base(2321)
		{
	...
	public class GSkill2322Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2322 : GSkill
	{
		public GSkill2322()
			: base(2322)
		{
	...
	public class GSkill2323Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2323 : GSkill
	{
		public GSkill2323()
			: base(2323)
		{
	...
	public class GSkill2324Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2324 : GSkill
	{
		public GSkill2324()
			: base(2324)
		{
	...
	public class GSkill2325Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2325)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ºüÑý_Æï³Ë_·¨±¦_·µ»êÏã");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill2325 : GSkill
	{
		public GSkill2325()
			: base(2325)
		{
	...
	public class GSkill2326Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2326)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ºüÑý_Æï³Ë_·¨±¦_¸¡Ó°¹Å¾µ");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
			...
			SetAction(24,"0");
			SetAction(25,"0");
			SetAction(26,"ºüÑý_Æï³Ë_·¨±¦_¸¡Ó°¹Å¾µ");
			SetAction(27,"0");
			SetAction(28,"0");
			SetAction(29,"0");
			SetAction(30,"0");
	...
	public class GSkill2326 : GSkill
	{
		public GSkill2326()
			: base(2326)
		{
	...
	public class GSkill2327Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2327 : GSkill
	{
		public GSkill2327()
			: base(2327)
		{
	...
	public class GSkill2328Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2328)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "ÕæÎä½£¸ó6boss¼¼ÄÜ1";
			nativename = "ÕæÎä½£¸ó6boss¼¼ÄÜ1";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill2328 : GSkill
	{
		public GSkill2328()
			: base(2328)
		{
	...
	public class GSkill2329Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2329)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "ÕæÎä½£¸ó6boss¼¼ÄÜ2";
			nativename = "ÕæÎä½£¸ó6boss¼¼ÄÜ2";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill2329 : GSkill
	{
		public GSkill2329()
			: base(2329)
		{
