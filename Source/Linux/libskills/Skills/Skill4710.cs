...
namespace SKILL
{
	public class GSkill4710Stub : GSkillStub
	{
		public GSkill4710Stub()
			: base(4710)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill4710 : GSkill
	{
		public GSkill4710()
			: base(4710)
		{
	...
	public class GSkill4711Stub : GSkillStub
	{
	...
	public class GSkill4711 : GSkill
	{
		public GSkill4711()
			: base(4711)
		{
	...
	public class GSkill4712Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4712 : GSkill
	{
		public GSkill4712()
			: base(4712)
		{
	...
	public class GSkill4713Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4713 : GSkill
	{
		public GSkill4713()
			: base(4713)
		{
	...
	public class GSkill4714Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue(55191.0f);
			victim.SetSummon(true);
			return true;
		}
	}
	public class GSkill4714 : GSkill
	{
		public GSkill4714()
			: base(4714)
		{
	...
	public class GSkill4715Stub : GSkillStub
	{
		public GSkill4715Stub()
			: base(4715)
		{
			occupation = 129;
			maxlevel = 200;
	...
	public class GSkill4715 : GSkill
	{
		public GSkill4715()
			: base(4715)
		{
	...
	public class GSkill4716Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4716 : GSkill
	{
		public GSkill4716()
			: base(4716)
		{
	...
	public class GSkill4717Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4717)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFFºì";
			nativename = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFFºì";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill4717 : GSkill
	{
		public GSkill4717()
			: base(4717)
		{
	...
	public class GSkill4718Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4718)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFF»Æ";
			nativename = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFF»Æ";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill4718 : GSkill
	{
		public GSkill4718()
			: base(4718)
		{
	...
	public class GSkill4719Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4719)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFFÀ¶";
			nativename = "ÉÏ¹Å¸±±¾ÏÝÚå¹ØBUFFÀ¶";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill4719 : GSkill
	{
		public GSkill4719()
			: base(4719)
		{
