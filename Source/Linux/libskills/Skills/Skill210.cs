...
namespace SKILL
{
	public class GSkill218Stub : GSkillStub
	{
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(6 * skill_level + 3);
				player.SetPerform(1);
			}
		}
		public GSkill218Stub()
			: base(218)
		{
			occupation = 0;
			maxlevel = 20;
			...
			SetAction(24,"ÇàÔÆÃÅ_Æï³Ë_Ç¬À¤Õ¶");
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"0");
			SetAction(28,"0");
		...
		{
			int[] array={1,2,3,5,7,10};return array[level-1];
		}
	...
	public class GSkill219Stub : GSkillStub
	{
		public GSkill219Stub()
			: base(219)
		{
			occupation = 0;
			maxlevel = 15;
		...
		public override int GetRequiredLevel(int level)
		{
			int[] array={3,5,7,9,11,13,15};return array[level-1];
		}
