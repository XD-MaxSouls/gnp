...
namespace SKILL
{
	public class GSkill4970Stub : GSkillStub
	{
		public GSkill4970Stub()
			: base(4970)
		{
			occupation = 130;
			maxlevel = 10;
	...
	public class GSkill4970 : GSkill
	{
		public GSkill4970()
			: base(4970)
		{
	...
	public class GSkill4971Stub : GSkillStub
	{
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(((3000 * skill_level + 5000)));
			victim.SetBuffid(1);
			victim.SetValue(((30 * skill_level)));
			victim.SetSubantidizzy(true);
			v41 = player_var3;
			if ( D2INT(zrand(100)) >= 10 * skill_level )
			v40 = 0.0f;
			else
			victim.SetProbability(((100 * v41)));
			...
			{
			v39 = ((50 * skill_level) + ((D2INT(player_level / (10 - skill_level)) * 0.01f + (skill_level * 0.03f + 1.0f)) * player_var2)) - player_def;
			}
			victim.SetValue(v39);
	...
	public class GSkill4971 : GSkill
	{
		public GSkill4971()
			: base(4971)
		{
	...
	public class GSkill4972Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4972 : GSkill
	{
		public GSkill4972()
			: base(4972)
		{
	...
	public class GSkill4973Stub : GSkillStub
	{
		public GSkill4973Stub()
			: base(4973)
		{
			occupation = 130;
			maxlevel = 5;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((skill_level * skill_level + 10)));
			victim.SetTime(((2000 * skill_level + 5000)));
			victim.SetRatio((skill_level * (skill_level * 0.03f)));
			victim.SetBuffid(2);
			victim.SetInccrithurt(true);
			return true;
		}
	}
	public class GSkill4973 : GSkill
	{
		public GSkill4973()
			: base(4973)
		{
	...
	public class GSkill4974Stub : GSkillStub
	{
		public GSkill4974Stub()
			: base(4974)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4974 : GSkill
	{
		public GSkill4974()
			: base(4974)
		{
	...
	public class GSkill4975Stub : GSkillStub
	{
		public GSkill4975Stub()
			: base(4975)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4975 : GSkill
	{
		public GSkill4975()
			: base(4975)
		{
	...
	public class GSkill4976Stub : GSkillStub
	{
		public GSkill4976Stub()
			: base(4976)
		{
			occupation = 130;
			maxlevel = 10;
	...
	public class GSkill4976 : GSkill
	{
		public GSkill4976()
			: base(4976)
		{
	...
	public class GSkill4977Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetRatio((skill_level * (skill_level * 0.02f)));
			victim.SetBuffid(2);
			victim.SetInccrithurt(true);
			return true;
		}
	...
	public class GSkill4977 : GSkill
	{
		public GSkill4977()
			: base(4977)
		{
	...
	public class GSkill4978Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			/*
			if ( player.GetTmplid() != 58672
			&& (v3 = player, GNET::PlayerWrapper::GetTmplid(v3) != 58673)
			&& (v4 = player, GNET::PlayerWrapper::GetTmplid(v4) != 58676) )
			d = 0.0f;
			else
	...
	public class GSkill4978 : GSkill
	{
		public GSkill4978()
			: base(4978)
		{
	...
	public class GSkill4979Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4979)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "2013¹úÇì½ÚºÈ¾Æ2";
			nativename = "2013¹úÇì½ÚºÈ¾Æ2";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(((zrand(78000) + 5000)));
			victim.SetRatio(4980.0f);
			victim.SetAmount(4980.0f);
			victim.SetValue(4980.0f);
			victim.SetSetcooldown(true);
			victim.SetProbability(120.0f);
			victim.SetTime(((zrand(78000) + 5000)));
			victim.SetRatio(4982.0f);
			victim.SetAmount(4982.0f);
			victim.SetValue(4982.0f);
			victim.SetSetcooldown(true);
			victim.SetProbability(120.0f);
			victim.SetTime(((zrand(78000) + 5000)));
			victim.SetRatio(4981.0f);
			victim.SetAmount(4981.0f);
			victim.SetValue(4981.0f);
			victim.SetSetcooldown(true);
			victim.SetProbability(2000.0f);
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetRatio(180.0f);
			victim.SetAmount(1.0f);
			victim.SetValue(60255.0f);
			victim.SetCreateitem(true);
			victim.SetProbability(120.0f);
			victim.SetTime(((zrand(78000) + 5000)));
			victim.SetRatio(4983.0f);
			victim.SetAmount(4983.0f);
			victim.SetValue(4983.0f);
			victim.SetSetcooldown(true);
			victim.SetProbability(120.0f);
			victim.SetTime(((zrand(78000) + 5000)));
			victim.SetRatio(4933.0f);
			victim.SetAmount(4933.0f);
			victim.SetValue(4933.0f);
			victim.SetSetcooldown(true);
			return true;
		}
	}
	public class GSkill4979 : GSkill
	{
		public GSkill4979()
			: base(4979)
		{
