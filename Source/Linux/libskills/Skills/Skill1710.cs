...
namespace SKILL
{
	public class GSkill1710Stub : GSkillStub
	{
	...
	public class GSkill1710 : GSkill
	{
		public GSkill1710()
			: base(1710)
		{
	...
	public class GSkill1711Stub : GSkillStub
	{
		public GSkill1711Stub()
			: base(1711)
		{
			occupation = 0;
			maxlevel = 20;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetAdddebuff(true);
			return true;
		}
	}
	public class GSkill1711 : GSkill
	{
		public GSkill1711()
			: base(1711)
		{
	...
	public class GSkill1712Stub : GSkillStub
	{
		public GSkill1712Stub()
			: base(1712)
		{
			occupation = 129;
			maxlevel = 10;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio(0.0f);
			victim.SetValue(((180 * skill_level * (norm(skill_level * ((player_maxhp * 0.66f + 1.0f) / 180.0f)))) + (player_maxhp * (norm(((180 * skill_level)) / (player_maxhp * 0.66f + 1.0f)) * 0.66f))));
			victim.SetHeal(true);
	...
	public class GSkill1712 : GSkill
	{
		public GSkill1712()
			: base(1712)
		{
	...
	public class GSkill1713Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1713 : GSkill
	{
		public GSkill1713()
			: base(1713)
		{
	...
	public class GSkill1714Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(1);
			victim.SetValue(player_atkrate);
			victim.SetAdddefence(true);
			victim.SetProbability(100.0f);
	...
	public class GSkill1714 : GSkill
	{
		public GSkill1714()
			: base(1714)
		{
	...
	public class GSkill1715Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(100.0f);
			victim.SetRatio(0.0f);
			victim.SetValue(((player_maxhp * skill_level) * 0.1f));
			victim.SetHeal(true);
			victim.SetProbability(100.0f);
			victim.SetTime(((3000 * skill_level + 15000)));
	...
	public class GSkill1715 : GSkill
	{
		public GSkill1715()
			: base(1715)
		{
	...
	public class GSkill1716Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount((skill_level * (player_maxmp * 0.1f)));
			victim.SetValue(0.0f);
	...
	public class GSkill1716 : GSkill
	{
		public GSkill1716()
			: base(1716)
		{
	...
	public class GSkill1717Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1717 : GSkill
	{
		public GSkill1717()
			: base(1717)
		{
	...
	public class GSkill1718Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1718 : GSkill
	{
		public GSkill1718()
			: base(1718)
		{
	...
	public class GSkill1719Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1719 : GSkill
	{
		public GSkill1719()
			: base(1719)
		{
