...
namespace SKILL
{
	public class GSkill4360Stub : GSkillStub
	{
			...
			: base(4360)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "ËÄÏó¹¬ÐþÎäÉß¼¼ÄÜ-½ûÊ³";
			nativename = "ËÄÏó¹¬ÐþÎäÉß¼¼ÄÜ-½ûÊ³";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill4360 : GSkill
	{
		public GSkill4360()
			: base(4360)
		{
	...
	public class GSkill4361Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4361)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "ËÄÏó¹¬ÐþÎä¶¾Îï-Èº¹¥";
			nativename = "ËÄÏó¹¬ÐþÎä¶¾Îï-Èº¹¥";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill4361 : GSkill
	{
		public GSkill4361()
			: base(4361)
		{
	...
	public class GSkill4362Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4362)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÐùÔ¯_Æï³Ë__·¨±¦_ÂÊ¶µÆì");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
			...
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"ÐùÔ¯_Æï³Ë__·¨±¦_ÂÊ¶µÆì");
			SetAction(28,"0");
			SetAction(29,"0");
			SetAction(30,"0");
			name = "ÂÊ¶µÉñ»ð";
	...
	public class GSkill4362 : GSkill
	{
		public GSkill4362()
			: base(4362)
		{
	...
	public class GSkill4363Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4363)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÐùÔ¯_Æï³Ë_·¨±¦_ÄõÁú¹Ä");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill4363 : GSkill
	{
		public GSkill4363()
			: base(4363)
		{
	...
	public class GSkill4364Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4364)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÐùÔ¯_Æï³Ë_·¨±¦_ÂäµØ½ðÇ®");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
			...
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"ÐùÔ¯_Æï³Ë_·¨±¦_ÂäµØ½ðÇ®");
			SetAction(28,"0");
			SetAction(29,"0");
			SetAction(30,"0");
			name = "Ç¬À¤Ò»ÖÀ";
	...
	public class GSkill4364 : GSkill
	{
		public GSkill4364()
			: base(4364)
		{
	...
	public class GSkill4365Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4365 : GSkill
	{
		public GSkill4365()
			: base(4365)
		{
	...
	public class GSkill4366Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4366 : GSkill
	{
		public GSkill4366()
			: base(4366)
		{
	...
	public class GSkill4367Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				if ( zrand(100) >= (skill_level + 1) * (skill_level + 1) )
				    ...
				    v = 1;
				player.SetVar16(v);
				skill.SetRatio(((skill_t0 + 1) * (D2INT((player_mp / 0.95f) / player_maxmp) * 0.08f) + (D2INT(player_level / (9 - skill_level)) * 0.01f + (skill_level * 0.07000000000000001f + (skill_t0 * 0.08f + 1.0f)))));
				skill.SetPlus((player_def * (skill_t2 * 0.03f) + ((215 * skill_level))));
				player.SetPerform(1);
				*/
			}
		}
		public GSkill4367Stub()
			: base(4367)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4367 : GSkill
	{
		public GSkill4367()
			: base(4367)
		{
	...
	public class GSkill4368Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4368 : GSkill
	{
		public GSkill4368()
			: base(4368)
		{
	...
	public class GSkill4369Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4369 : GSkill
	{
		public GSkill4369()
			: base(4369)
		{
