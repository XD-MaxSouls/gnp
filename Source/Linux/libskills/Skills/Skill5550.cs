...
namespace SKILL
{
	public class GSkill5550Stub : GSkillStub
	{
			...
			: base(5550)
		{
			...
			SetAction(13,"0");
			SetAction(14,"0");
			SetAction(15,"ÎäÆ÷´óÊ¦_·¨±¦_Ø°Ê×");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÎäÆ÷´óÊ¦_Æï³Ë_·¨±¦_Ø°Ê×");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill5551Stub : GSkillStub
	{
			...
			: base(5551)
		{
			...
			SetAction(13,"0");
			SetAction(14,"0");
			SetAction(15,"ÎäÆ÷´óÊ¦_·¨±¦_´óµ¶");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÎäÆ÷´óÊ¦_Æï³Ë_·¨±¦_´óµ¶");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill5552Stub : GSkillStub
	{
			...
			: base(5552)
		{
			...
			SetAction(13,"0");
			SetAction(14,"0");
			SetAction(15,"ÎäÆ÷´óÊ¦_·¨±¦_¸«");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÎäÆ÷´óÊ¦_Æï³Ë_·¨±¦_¸«");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill5554Stub : GSkillStub
	{
			...
			: base(5554)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "¡¾ÉÐÎ´ÁìÎò¡¿Á÷·ç»ØÑ©";
			nativename = "¡¾ÉÐÎ´ÁìÎò¡¿Á÷·ç»ØÑ©";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill5557Stub : GSkillStub
	{
			...
			: base(5557)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "¡¾ÉÐÎ´ÁìÎò¡¿´©ÔÆÖðÔÂ";
			nativename = "¡¾ÉÐÎ´ÁìÎò¡¿´©ÔÆÖðÔÂ";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill5559Stub : GSkillStub
	{
			...
			: base(5559)
		{
			...
			SetAction(29,"");
			SetAction(30,"");
			name = "¡¾ÉÐÎ´ÁìÎò¡¿Íò·òÄª¿ª";
			nativename = "¡¾ÉÐÎ´ÁìÎò¡¿Íò·òÄª¿ª";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
