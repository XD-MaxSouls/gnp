...
namespace SKILL
{
	public class GSkill2660Stub : GSkillStub
	{
	...
	public class GSkill2660 : GSkill
	{
		public GSkill2660()
			: base(2660)
		{
	...
	public class GSkill2661Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(1);
			victim.SetAmount(((5 * player_var1)));
			victim.SetValue(0.0f);
			victim.SetHpleak(true);
			return true;
		}
	}
	public class GSkill2661 : GSkill
	{
		public GSkill2661()
			: base(2661)
		{
	...
	public class GSkill2662Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2662 : GSkill
	{
		public GSkill2662()
			: base(2662)
		{
	...
	public class GSkill2663Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2663 : GSkill
	{
		public GSkill2663()
			: base(2663)
		{
	...
	public class GSkill2664Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2664 : GSkill
	{
		public GSkill2664()
			: base(2664)
		{
	...
	public class GSkill2665Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetRatio(54.0f);
			victim.SetAmount(4.0f);
			victim.SetValue(42.0f);
			victim.SetDispel(true);
			*/
			return true;
		}
	}
	public class GSkill2665 : GSkill
	{
		public GSkill2665()
			: base(2665)
		{
	...
	public class GSkill2666Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2666 : GSkill
	{
		public GSkill2666()
			: base(2666)
		{
	...
	public class GSkill2667Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetAmount((player_var2 * 0.15f * 15.0f));
			victim.SetValue(0.0f);
			victim.SetHpleak(true);
			return true;
		}
	}
	public class GSkill2667 : GSkill
	{
		public GSkill2667()
			: base(2667)
		{
	...
	public class GSkill2668Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2668 : GSkill
	{
		public GSkill2668()
			: base(2668)
		{
	...
	public class GSkill2669Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2669 : GSkill
	{
		public GSkill2669()
			: base(2669)
		{
