...
namespace SKILL
{
	public class GSkill4940Stub : GSkillStub
	{
	...
	public class GSkill4940 : GSkill
	{
		public GSkill4940()
			: base(4940)
		{
	...
	public class GSkill4941Stub : GSkillStub
	{
		public GSkill4941Stub()
			: base(4941)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4941 : GSkill
	{
		public GSkill4941()
			: base(4941)
		{
	...
	public class GSkill4942Stub : GSkillStub
	{
		public GSkill4942Stub()
			: base(4942)
		{
			occupation = 130;
			maxlevel = 5;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue(((50 * skill_level + 200)));
			victim.SetHpregain(true);
			return true;
		}
	}
	public class GSkill4942 : GSkill
	{
		public GSkill4942()
			: base(4942)
		{
	...
	public class GSkill4943Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4943 : GSkill
	{
		public GSkill4943()
			: base(4943)
		{
	...
	public class GSkill4944Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4944 : GSkill
	{
		public GSkill4944()
			: base(4944)
		{
	...
	public class GSkill4945Stub : GSkillStub
	{
		public GSkill4945Stub()
			: base(4945)
		{
			occupation = 130;
			maxlevel = 5;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetAmount(((6690 * skill_level)));
	...
	public class GSkill4945 : GSkill
	{
		public GSkill4945()
			: base(4945)
		{
	...
	public class GSkill4946Stub : GSkillStub
	{
		public GSkill4946Stub()
			: base(4946)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4946 : GSkill
	{
		public GSkill4946()
			: base(4946)
		{
	...
	public class GSkill4947Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4947)
		{
			...
			weapon_limit = -1;
			SetAction(0,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(1,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(2,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(3,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(4,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(5,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(6,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(7,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(8,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(9,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(10,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(11,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(12,"»³¹â_·¨±¦_ÆÆ¾ü");
			SetAction(13,"ÁéÙí_·¨±¦_ÂÞ_Óñ");
			SetAction(14,"0");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(19,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(20,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(21,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(22,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(23,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(24,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(25,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(26,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(27,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(28,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(29,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			SetAction(30,"»³¹â_Æï³Ë_·¨±¦_ÆÆ¾ü");
			name = "³Ð¡¤ÐÇÔÉÉß±ä";
	...
	public class GSkill4947 : GSkill
	{
		public GSkill4947()
			: base(4947)
		{
	...
	public class GSkill4948Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4948 : GSkill
	{
		public GSkill4948()
			: base(4948)
		{
	...
	public class GSkill4949Stub : GSkillStub
	{
		public GSkill4949Stub()
			: base(4949)
		{
			occupation = 130;
			maxlevel = 5;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(20000.0f);
			victim.SetBuffid(1);
			victim.SetValue(((45 * skill_level)));
	...
	public class GSkill4949 : GSkill
	{
		public GSkill4949()
			: base(4949)
		{
