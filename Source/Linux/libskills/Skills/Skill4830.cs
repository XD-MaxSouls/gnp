...
namespace SKILL
{
	public class GSkill4830Stub : GSkillStub
	{
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetValue(((6 * skill_level + 24)));
			victim.SetHpregain(true);
			return true;
		}
	}
	public class GSkill4830 : GSkill
	{
		public GSkill4830()
			: base(4830)
		{
	...
	public class GSkill4831Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetAmount(((690 * skill_level)));
	...
	public class GSkill4831 : GSkill
	{
		public GSkill4831()
			: base(4831)
		{
	...
	public class GSkill4832Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetValue(((player_maxmp * (skill_level + 2)) * 0.01f));
			victim.SetMpgen(true);
			return true;
		}
	}
	public class GSkill4832 : GSkill
	{
		public GSkill4832()
			: base(4832)
		{
	...
	public class GSkill4833Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			/*
			if ( zrand(100) >= 6 * skill_level + 20 )
			t = 0.0f;
			else
			victim.SetTime(12000.0f);
			victim.SetAmount(((2 * skill_level + 5)));
			victim.SetValue(((40 * skill_level + 80)));
			victim.SetCursed(true);
			victim.SetProbability(((3 * skill_level + 10)));
			victim.SetTime(12000.0f);
			victim.SetBuffid(1);
			victim.SetAmount(((725 * skill_level)));
			victim.SetValue(0.0f);
			victim.SetHpleak(true);
			*/
			return true;
	...
	public class GSkill4833 : GSkill
	{
		public GSkill4833()
			: base(4833)
		{
	...
	public class GSkill4834Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4834 : GSkill
	{
		public GSkill4834()
			: base(4834)
		{
	...
	public class GSkill4835Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4835 : GSkill
	{
		public GSkill4835()
			: base(4835)
		{
	...
	public class GSkill4836Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4836 : GSkill
	{
		public GSkill4836()
			: base(4836)
		{
	...
	public class GSkill4837Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4837 : GSkill
	{
		public GSkill4837()
			: base(4837)
		{
	...
	public class GSkill4838Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus((((20 * skill_level + 50) * norm(30 / player_level) + (5 * skill_level) + 40)));
				player.SetPerform(1);
			}
		}
		public GSkill4838Stub()
			: base(4838)
		{
			occupation = 108;
			maxlevel = 8;
	...
	public class GSkill4838 : GSkill
	{
		public GSkill4838()
			: base(4838)
		{
	...
	public class GSkill4839Stub : GSkillStub
	{
		public GSkill4839Stub()
			: base(4839)
		{
			occupation = 108;
			maxlevel = 8;
	...
	public class GSkill4839 : GSkill
	{
		public GSkill4839()
			: base(4839)
		{
