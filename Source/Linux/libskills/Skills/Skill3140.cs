...
namespace SKILL
{
	public class GSkill3140Stub : GSkillStub
	{
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(((2000 * skill_t0 + (1000 * skill_level) + 10000)));
	...
	public class GSkill3140 : GSkill
	{
		public GSkill3140()
			: base(3140)
		{
	...
	public class GSkill3141Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			if ( player_var2 <= 0 )
			{
			v10 = (2 * skill_level + player_var1);
			}
			else
			{
			v10 = (10 * skill_level + 600);
			}
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(((2000 * norm(skill_level / 19.9f) + (300 * skill_level) + 5050)));
			...
			{
			v31 = (27 * D2INT((zrand(2 * skill_level + 100)) / 100) + 2419);
			}
			victim.SetRatio(v31);
			victim.SetAmount(2419.0f);
			victim.SetValue(2419.0f);
	...
	public class GSkill3141 : GSkill
	{
		public GSkill3141()
			: base(3141)
		{
	...
	public class GSkill3142Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((player_res1 * (skill_level + 2)) + (skill_t0 * (player_hp * 0.05f) + ((10 * skill_level + 244)))));
				player.SetHp(((1.0f - skill_t0 * 0.05f) * player_hp));
				player.SetPerform(1);
			}
		}
		public GSkill3142Stub()
			: base(3142)
		{
			occupation = 169;
			maxlevel = 20;
	...
	public class GSkill3142 : GSkill
	{
		public GSkill3142()
			: base(3142)
		{
	...
	public class GSkill3143Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetTime(((1000 * skill_level + 10000)));
			victim.SetBuffid(2);
			victim.SetValue(((player_res1 * skill_level) * 0.005f));
	...
	public class GSkill3143 : GSkill
	{
		public GSkill3143()
			: base(3143)
		{
	...
	public class GSkill3144Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(((5000 * skill_t0 + (1000 * skill_level) + 15050)));
			victim.SetRatio(3.0f);
			victim.SetBuffid(0);
			victim.SetAmount(((D2INT(skill_level / 19.9f) + 1)));
			victim.SetValue(34670.0f);
			victim.SetSummonclone(true);
			victim.SetProbability(((3 * skill_level + 20)));
	...
	public class GSkill3144 : GSkill
	{
		public GSkill3144()
			: base(3144)
		{
	...
	public class GSkill3145Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus((skill_j0 * ((skill_level * 0.2f + 2.0f) * player_res5) + ((13 * skill_level) + (skill_level * (skill_level * 0.07099999999999999f)) + 1027.0f)));
				player.SetPerform(1);
			}
		}
		public GSkill3145Stub()
			: base(3145)
		{
			occupation = 169;
			maxlevel = 20;
			...
			name = "ÉñÒý£ºÑô¹ØÈýµþ<ìø>";
			nativename = "ÉñÒý£ºÑô¹ØÈýµþ<ìø>";
			icon = "·ð¡¤ÉñÒý£ºÑô¹ØÈýµþ.dds";
			SetTalent(0,2610);
			SetTalent(1,2605);
			SetTalent(2,2606);
			SetTalent(3,0);
	...
	public class GSkill3145 : GSkill
	{
		public GSkill3145()
			: base(3145)
		{
	...
	public class GSkill3146Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3146 : GSkill
	{
		public GSkill3146()
			: base(3146)
		{
	...
	public class GSkill3147Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((90 * skill_j0) + ((skill_level * 0.2f + 3.0f) * ((player_res4 * skill_j0)) + ((14 * skill_level) + (skill_level * (skill_level * 0.091f))) + 543.0f)));
				player.SetPerform(1);
			}
		}
			...
			: base(3147)
		{
			...
			name = "ÉñÒý£ºÃ·»¨ÈýÅª<ìø>";
			nativename = "ÉñÒý£ºÃ·»¨ÈýÅª<ìø>";
			icon = "·ð¡¤ÉñÒý£ºÃ·»¨ÈýÅª.dds";
			SetTalent(0,2617);
			SetTalent(1,2605);
			SetTalent(2,2606);
			SetTalent(3,0);
	...
	public class GSkill3147 : GSkill
	{
		public GSkill3147()
			: base(3147)
		{
	...
	public class GSkill3148Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetTime(((500 * skill_level + 2050)));
			victim.SetBuffid(1);
			victim.SetValue(((2 * player_res5 * skill_level)));
	...
	public class GSkill3148 : GSkill
	{
		public GSkill3148()
			: base(3148)
		{
	...
	public class GSkill3149Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			/*
			victim.SetProbability(100.0f);
			victim.SetTime(((1000 * D2INT(skill_level / 10))));
			victim.SetBuffid(1);
			if ( skill_level <= 9 )
			{
			d = skill_level;
			...
			{
			d = (skill_level - 10 * D2INT(skill_level / 10));
			}
			victim.SetValue(d);
			victim.SetAddspeed(true);
			*/
	...
	public class GSkill3149 : GSkill
	{
		public GSkill3149()
			: base(3149)
		{
