...
namespace SKILL
{
	public class GSkill3710Stub : GSkillStub
	{
		public GSkill3710Stub()
			: base(3710)
		{
			occupation = 128;
			maxlevel = 5;
	...
	public class GSkill3710 : GSkill
	{
		public GSkill3710()
			: base(3710)
		{
	...
	public class GSkill3711Stub : GSkillStub
	{
	...
	public class GSkill3711 : GSkill
	{
		public GSkill3711()
			: base(3711)
		{
	...
	public class GSkill3712Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(1);
			victim.SetAmount(15000.0f);
			victim.SetValue(1000.0f);
			victim.SetHpleak3(true);
			return true;
		}
	}
	public class GSkill3712 : GSkill
	{
		public GSkill3712()
			: base(3712)
		{
	...
	public class GSkill3713Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue((skill_level * (player_maxhp * 0.1f)));
			victim.SetSubhp(true);
			return true;
		}
	}
	public class GSkill3713 : GSkill
	{
		public GSkill3713()
			: base(3713)
		{
	...
	public class GSkill3714Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3714 : GSkill
	{
		public GSkill3714()
			: base(3714)
		{
	...
	public class GSkill3715Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3715 : GSkill
	{
		public GSkill3715()
			: base(3715)
		{
	...
	public class GSkill3716Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3716 : GSkill
	{
		public GSkill3716()
			: base(3716)
		{
	...
	public class GSkill3717Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			{
			v44 = ((player_var3 - player_skilldodge + 1000) / 10 + 20);
			}
			d = v44;
			}
			...
			{
			v42 = (zrand(10) * 0.01f + 0.95f) * player_var1;
			}
			victim.SetValue(v42);
			...
			if ( skill_level != 2 && skill_level != 3 )
			t = 1.0f;
			else
			victim.SetTime(3100.0f);
			if ( skill_level == 2 )
		...
		public override int GetExcludemonsterTid(int index)
		{
			int[] array={45507,50295,50296,50297};return array[index-1];
		}
	}
	public class GSkill3717 : GSkill
	{
		public GSkill3717()
			: base(3717)
		{
	...
	public class GSkill3718Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetRatio((zrand(10) * 0.1f + 1.0f));
				skill.SetPlus(1000.0f);
				player.SetPerform(1);
			}
		}
		public GSkill3718Stub()
			: base(3718)
		{
			occupation = 128;
			maxlevel = 99;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue(485.0f);
			victim.SetTransform(true);
			*/
			return true;
		}
	}
	public class GSkill3718 : GSkill
	{
		public GSkill3718()
			: base(3718)
		{
	...
	public class GSkill3719Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill3719 : GSkill
	{
		public GSkill3719()
			: base(3719)
		{
