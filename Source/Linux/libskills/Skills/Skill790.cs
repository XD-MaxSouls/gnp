...
namespace SKILL
{
	public class GSkill790Stub : GSkillStub
	{
			...
			: base(790)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"天音寺_万象生佛");
			SetAction(1,"天音寺_万象生佛");
			SetAction(2,"天音寺_万象生佛");
			SetAction(3,"天音寺_万象生佛");
			SetAction(4,"天音寺_万象生佛");
			SetAction(5,"天音寺_万象生佛");
			SetAction(6,"0");
			SetAction(7,"0");
			SetAction(8,"0");
			SetAction(9,"0");
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"天音寺_骑乘_万象生佛");
			SetAction(19,"天音寺_骑乘_万象生佛");
			SetAction(20,"天音寺_骑乘_万象生佛");
			SetAction(21,"天音寺_骑乘_万象生佛");
			SetAction(22,"天音寺_骑乘_万象生佛");
			SetAction(23,"天音寺_骑乘_万象生佛");
			SetAction(24,"0");
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"0");
	...
	public class GSkill792Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill793Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill794Stub : GSkillStub
	{
		public GSkill794Stub()
			: base(794)
		{
			occupation = 129;
			maxlevel = 200;
	...
	public class GSkill795Stub : GSkillStub
	{
		public GSkill795Stub()
			: base(795)
		{
			occupation = 129;
			maxlevel = 500;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue((player_maxhp * ((2 * skill_level) * 0.3f)));
			victim.SetHpgen(true);
			return true;
		}
	}
	public class GSkill795 : GSkill
	{
		public GSkill795()
			: base(795)
		{
	...
	public class GSkill796Stub : GSkillStub
	{
		public GSkill796Stub()
			: base(796)
		{
			occupation = 129;
			maxlevel = 10;
	...
	public class GSkill797Stub : GSkillStub
	{
		public GSkill797Stub()
			: base(797)
		{
			occupation = 129;
			maxlevel = 10;
	...
	public class GSkill798Stub : GSkillStub
	{
		public GSkill798Stub()
			: base(798)
		{
			occupation = 129;
			maxlevel = 10;
	...
	public class GSkill799Stub : GSkillStub
	{
		public GSkill799Stub()
			: base(799)
		{
			occupation = 129;
			maxlevel = 10;
