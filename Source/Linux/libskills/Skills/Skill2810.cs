...
namespace SKILL
{
	public class GSkill2810Stub : GSkillStub
	{
	...
	public class GSkill2810 : GSkill
	{
		public GSkill2810()
			: base(2810)
		{
	...
	public class GSkill2811Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2811 : GSkill
	{
		public GSkill2811()
			: base(2811)
		{
	...
	public class GSkill2812Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2812 : GSkill
	{
		public GSkill2812()
			: base(2812)
		{
	...
	public class GSkill2813Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2813)
		{
			...
			SetAction(29,"0");
			SetAction(30,"0");
			name = "LTÖ»¶ÔÌØ¶¨ËþÉúÐ§µÄ¹¥³Ç³µ¼¼ÄÜ";
			nativename = "LTÖ»¶ÔÌØ¶¨ËþÉúÐ§µÄ¹¥³Ç³µ¼¼ÄÜ";
			icon = "";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill2813 : GSkill
	{
		public GSkill2813()
			: base(2813)
		{
	...
	public class GSkill2814Stub : GSkillStub
	{
		public GSkill2814Stub()
			: base(2814)
		{
			occupation = 129;
			maxlevel = 99;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetValue(((skill_level + 37802)));
			victim.SetSummon(true);
			return true;
		}
	}
	public class GSkill2814 : GSkill
	{
		public GSkill2814()
			: base(2814)
		{
	...
	public class GSkill2815Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2815 : GSkill
	{
		public GSkill2815()
			: base(2815)
		{
	...
	public class GSkill2816Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2816 : GSkill
	{
		public GSkill2816()
			: base(2816)
		{
	...
	public class GSkill2817Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2817)
		{
			...
			SetAction(19,"ÇàÔÆÃÅ_Æï³Ë_ÎåÀ×ºä¶¥");
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount(1.0f);
			victim.SetValue(38181.0f);
			victim.SetSummon(true);
			return true;
		}
	}
	public class GSkill2817 : GSkill
	{
		public GSkill2817()
			: base(2817)
		{
	...
	public class GSkill2818Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2818 : GSkill
	{
		public GSkill2818()
			: base(2818)
		{
	...
	public class GSkill2819Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2819 : GSkill
	{
		public GSkill2819()
			: base(2819)
		{
