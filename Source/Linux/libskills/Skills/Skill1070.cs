...
namespace SKILL
{
	public class GSkill1070Stub : GSkillStub
	{
	...
	public class GSkill1070 : GSkill
	{
		public GSkill1070()
			: base(1070)
		{
	...
	public class GSkill1071Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1071 : GSkill
	{
		public GSkill1071()
			: base(1071)
		{
	...
	public class GSkill1072Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount(((player_maxhp - player_hp) * (skill_level * 0.01f)));
			victim.SetValue(0.0f);
			victim.SetHpgen(true);
			return true;
		}
	}
	public class GSkill1072 : GSkill
	{
		public GSkill1072()
			: base(1072)
		{
	...
	public class GSkill1073Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(8000.0f);
			victim.SetBuffid(0);
			victim.SetAmount(((2 * (player_maxmp - player_mp))));
	...
	public class GSkill1073 : GSkill
	{
		public GSkill1073()
			: base(1073)
		{
	...
	public class GSkill1074Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(90.0f);
			victim.SetTime(((1800 * skill_level)));
			victim.SetBuffid(0);
			victim.SetAmount((player_maxhp * 0.5f + 1.0f));
	...
	public class GSkill1074 : GSkill
	{
		public GSkill1074()
			: base(1074)
		{
	...
	public class GSkill1075Stub : GSkillStub
	{
		public GSkill1075Stub()
			: base(1075)
		{
			occupation = 129;
			maxlevel = 9999;
	...
	public class GSkill1075 : GSkill
	{
		public GSkill1075()
			: base(1075)
		{
	...
	public class GSkill1076Stub : GSkillStub
	{
		public GSkill1076Stub()
			: base(1076)
		{
			occupation = 129;
			maxlevel = 9999;
	...
	public class GSkill1076 : GSkill
	{
		public GSkill1076()
			: base(1076)
		{
	...
	public class GSkill1077Stub : GSkillStub
	{
		public GSkill1077Stub()
			: base(1077)
		{
			occupation = 129;
			maxlevel = 9999;
	...
	public class GSkill1077 : GSkill
	{
		public GSkill1077()
			: base(1077)
		{
	...
	public class GSkill1078Stub : GSkillStub
	{
		public GSkill1078Stub()
			: base(1078)
		{
			occupation = 129;
			maxlevel = 9999;
	...
	public class GSkill1078 : GSkill
	{
		public GSkill1078()
			: base(1078)
		{
	...
	public class GSkill1079Stub : GSkillStub
	{
		public GSkill1079Stub()
			: base(1079)
		{
			occupation = 129;
			maxlevel = 9999;
	...
	public class GSkill1079 : GSkill
	{
		public GSkill1079()
			: base(1079)
		{
