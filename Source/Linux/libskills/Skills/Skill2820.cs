...
namespace SKILL
{
	public class GSkill2820Stub : GSkillStub
	{
	...
	public class GSkill2820 : GSkill
	{
		public GSkill2820()
			: base(2820)
		{
	...
	public class GSkill2821Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2821 : GSkill
	{
		public GSkill2821()
			: base(2821)
		{
	...
	public class GSkill2822Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((10 * skill_level + ((player_res5 + (player_res4 + (player_res3 + (player_res2 + player_res1)))) / 5))));
			victim.SetTime(((1000 * skill_level + 1000)));
			victim.SetSilent(true);
			victim.SetTime(12000.0f);
	...
	public class GSkill2822 : GSkill
	{
		public GSkill2822()
			: base(2822)
		{
	...
	public class GSkill2823Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2823)
		{
			...
			SetAction(10,"0");
			SetAction(11,"0");
			SetAction(12,"ÃÏª™_∑®±¶_æ≈“Ù¬›");
			SetAction(13,"");
			SetAction(14,"");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÃÏª™_∆Ô≥À_∑®±¶_æ≈“Ù¬›");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill2823 : GSkill
	{
		public GSkill2823()
			: base(2823)
		{
	...
	public class GSkill2824Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2824 : GSkill
	{
		public GSkill2824()
			: base(2824)
		{
	...
	public class GSkill2825Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2825 : GSkill
	{
		public GSkill2825()
			: base(2825)
		{
	...
	public class GSkill2826Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(2826)
		{
			...
			SetAction(10,"0");
			SetAction(11,"0");
			SetAction(12,"ÃÏª™_∑®±¶_±Ã¬‰∑…∫Ë");
			SetAction(13,"");
			SetAction(14,"");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"ÃÏª™_∆Ô≥À_∑®±¶_±Ã¬‰∑…∫Ë");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			if ( (player_res5 + (player_res4 + (player_res3 + (player_res2 + player_res1)))) / 240 > 50 )
			{
			v40 = 60.0f;
			}
			else
			{
			v40 = ((player_res5 + (player_res4 + (player_res3 + (player_res2 + player_res1)))) / 240 + 10);
			}
			victim.SetProbability(v40);
	...
	public class GSkill2826 : GSkill
	{
		public GSkill2826()
			: base(2826)
		{
	...
	public class GSkill2827Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			/*
			if ( player.GetTmplid() != 38178
			&& (v3 = player, GNET::PlayerWrapper::GetTmplid(v3) != 38179)
			&& (v4 = player, GNET::PlayerWrapper::GetTmplid(v4) != 38180) )
			d = 0.0f;
			else
	...
	public class GSkill2827 : GSkill
	{
		public GSkill2827()
			: base(2827)
		{
	...
	public class GSkill2828Stub : GSkillStub
	{
		public GSkill2828Stub()
			: base(2828)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2828 : GSkill
	{
		public GSkill2828()
			: base(2828)
		{
	...
	public class GSkill2829Stub : GSkillStub
	{
		public GSkill2829Stub()
			: base(2829)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2829 : GSkill
	{
		public GSkill2829()
			: base(2829)
		{
