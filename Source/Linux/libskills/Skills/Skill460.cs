...
namespace SKILL
{
	public class GSkill460Stub : GSkillStub
	{
		public GSkill460Stub()
			: base(460)
		{
			occupation = 7;
			maxlevel = 8;
		...
		{
			int[] array={16,24,32};return array[level-1];
		}
	...
	public class GSkill461Stub : GSkillStub
	{
		public GSkill461Stub()
			: base(461)
		{
			occupation = 9;
			maxlevel = 8;
	...
	public class GSkill462Stub : GSkillStub
	{
		public GSkill462Stub()
			: base(462)
		{
			occupation = 1;
			maxlevel = 4;
	...
	public class GSkill463Stub : GSkillStub
	{
		public GSkill463Stub()
			: base(463)
		{
			occupation = 3;
			maxlevel = 8;
	...
	public class GSkill464Stub : GSkillStub
	{
		public GSkill464Stub()
			: base(464)
		{
			occupation = 10;
			maxlevel = 8;
	...
	public class GSkill465Stub : GSkillStub
	{
		public GSkill465Stub()
			: base(465)
		{
			occupation = 12;
			maxlevel = 8;
	...
	public class GSkill466Stub : GSkillStub
	{
		public GSkill466Stub()
			: base(466)
		{
			occupation = 4;
			maxlevel = 8;
	...
	public class GSkill467Stub : GSkillStub
	{
		public GSkill467Stub()
			: base(467)
		{
			occupation = 6;
			maxlevel = 8;
	...
	public class GSkill468Stub : GSkillStub
	{
			...
			: base(468)
		{
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"合欢派_骑乘_迷离");
			SetAction(19,"合欢派_骑乘_迷离");
			SetAction(20,"合欢派_骑乘_迷离");
			SetAction(21,"合欢派_骑乘_迷离");
			SetAction(22,"合欢派_骑乘_迷离");
			SetAction(23,"0");
			SetAction(24,"");
			SetAction(25,"");
			SetAction(26,"");
	...
	public class GSkill469Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
