...
namespace SKILL
{
	public class GSkill4050Stub : GSkillStub
	{
	...
	public class GSkill4050 : GSkill
	{
		public GSkill4050()
			: base(4050)
		{
	...
	public class GSkill4051Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4051 : GSkill
	{
		public GSkill4051()
			: base(4051)
		{
	...
	public class GSkill4052Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4052 : GSkill
	{
		public GSkill4052()
			: base(4052)
		{
	...
	public class GSkill4053Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4053 : GSkill
	{
		public GSkill4053()
			: base(4053)
		{
	...
	public class GSkill4054Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4054 : GSkill
	{
		public GSkill4054()
			: base(4054)
		{
	...
	public class GSkill4055Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4055 : GSkill
	{
		public GSkill4055()
			: base(4055)
		{
	...
	public class GSkill4056Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4056 : GSkill
	{
		public GSkill4056()
			: base(4056)
		{
	...
	public class GSkill4057Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4057 : GSkill
	{
		public GSkill4057()
			: base(4057)
		{
	...
	public class GSkill4058Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				if ( zrand(100) >= (skill_level + 1) * (skill_level + 1) )
				    ...
				    v = 1;
				player.SetVar16(v);
				skill.SetRatio((D2INT(player_level / (9 - skill_level)) * 0.02f + (skill_t0 * 0.1f + (skill_level * 0.08f + 1.0f))));
				skill.SetPlus((player_def * (skill_t1 * 0.03f) + ((300 * skill_level))));
				player.SetPerform(1);
				*/
			}
		}
		public GSkill4058Stub()
			: base(4058)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4058 : GSkill
	{
		public GSkill4058()
			: base(4058)
		{
	...
	public class GSkill4059Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4059 : GSkill
	{
		public GSkill4059()
			: base(4059)
		{
