...
namespace SKILL
{
	public class GSkill2670Stub : GSkillStub
	{
	...
	public class GSkill2670 : GSkill
	{
		public GSkill2670()
			: base(2670)
		{
	...
	public class GSkill2671Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2671 : GSkill
	{
		public GSkill2671()
			: base(2671)
		{
	...
	public class GSkill2672Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2672 : GSkill
	{
		public GSkill2672()
			: base(2672)
		{
	...
	public class GSkill2673Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2673 : GSkill
	{
		public GSkill2673()
			: base(2673)
		{
	...
	public class GSkill2674Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2674 : GSkill
	{
		public GSkill2674()
			: base(2674)
		{
	...
	public class GSkill2675Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2675 : GSkill
	{
		public GSkill2675()
			: base(2675)
		{
	...
	public class GSkill2676Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2676 : GSkill
	{
		public GSkill2676()
			: base(2676)
		{
	...
	public class GSkill2677Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				player.SetMp(0.0f);
				player.SetHp(1.0f);
				player.SetDie((zrand(100) > 9));
				player.SetPerform(1);
			}
		}
		public GSkill2677Stub()
			: base(2677)
		{
			occupation = 146;
			maxlevel = 1;
	...
	public class GSkill2677 : GSkill
	{
		public GSkill2677()
			: base(2677)
		{
	...
	public class GSkill2678Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2678 : GSkill
	{
		public GSkill2678()
			: base(2678)
		{
	...
	public class GSkill2679Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2679 : GSkill
	{
		public GSkill2679()
			: base(2679)
		{
