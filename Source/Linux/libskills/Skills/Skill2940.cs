...
namespace SKILL
{
	public class GSkill2940Stub : GSkillStub
	{
	...
	public class GSkill2940 : GSkill
	{
		public GSkill2940()
			: base(2940)
		{
	...
	public class GSkill2941Stub : GSkillStub
	{
		public GSkill2941Stub()
			: base(2941)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2941 : GSkill
	{
		public GSkill2941()
			: base(2941)
		{
	...
	public class GSkill2942Stub : GSkillStub
	{
		public GSkill2942Stub()
			: base(2942)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2942 : GSkill
	{
		public GSkill2942()
			: base(2942)
		{
	...
	public class GSkill2943Stub : GSkillStub
	{
		public GSkill2943Stub()
			: base(2943)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2943 : GSkill
	{
		public GSkill2943()
			: base(2943)
		{
	...
	public class GSkill2944Stub : GSkillStub
	{
		public GSkill2944Stub()
			: base(2944)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2944 : GSkill
	{
		public GSkill2944()
			: base(2944)
		{
	...
	public class GSkill2945Stub : GSkillStub
	{
		public GSkill2945Stub()
			: base(2945)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2945 : GSkill
	{
		public GSkill2945()
			: base(2945)
		{
	...
	public class GSkill2946Stub : GSkillStub
	{
		public GSkill2946Stub()
			: base(2946)
		{
			occupation = 128;
			maxlevel = 10;
	...
	public class GSkill2946 : GSkill
	{
		public GSkill2946()
			: base(2946)
		{
	...
	public class GSkill2947Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2947 : GSkill
	{
		public GSkill2947()
			: base(2947)
		{
	...
	public class GSkill2948Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((46 * skill_level + 726)));
				  v9 = (0.01f * skill_level) + 1.1f;
				if ( (2 * player_hp) >= player_maxhp )
				    v8 = (v9 + 0.0f) + 1.2f;
				  else
				skill.SetRatio(((skill_t0 * 0.1f + v9) + 1.2f));
				player.SetPerform(1);
				*/
			}
			public override bool Cancel(GSkill skill)
	...
	public class GSkill2948 : GSkill
	{
		public GSkill2948()
			: base(2948)
		{
	...
	public class GSkill2949Stub : GSkillStub
	{
		public GSkill2949Stub()
			: base(2949)
		{
			occupation = 129;
			maxlevel = 1;
	...
	public class GSkill2949 : GSkill
	{
		public GSkill2949()
			: base(2949)
		{
