...
namespace SKILL
{
	public class GSkill2640Stub : GSkillStub
	{
			...
			: base(2640)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"10ÇéÈË×°ÄĞ");
			SetAction(1,"10ÇéÈË×°ÄĞ");
			SetAction(2,"10ÇéÈË×°ÄĞ");
			SetAction(3,"10ÇéÈË×°ÄĞ");
			SetAction(4,"10ÇéÈË×°ÄĞ");
			SetAction(5,"10ÇéÈË×°ÄĞ");
			SetAction(6,"10ÇéÈË×°ÄĞ");
			SetAction(7,"10ÇéÈË×°ÄĞ");
			SetAction(8,"10ÇéÈË×°ÄĞ");
			SetAction(9,"10ÇéÈË×°ÄĞ");
			SetAction(10,"10ÇéÈË×°ÄĞ");
			SetAction(11,"10ÇéÈË×°ÄĞ");
			SetAction(12,"10ÇéÈË×°ÄĞ");
			SetAction(13,"");
			SetAction(14,"");
			SetAction(15,"");
			SetAction(16,"");
	...
	public class GSkill2640 : GSkill
	{
		public GSkill2640()
			: base(2640)
		{
	...
	public class GSkill2641Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			{
			v11 = (player_var2 * 1.2f - 100.0f) * 0.01f;
			}
			d = v11;
			}
			victim.SetRatio(d);
	...
	public class GSkill2641 : GSkill
	{
		public GSkill2641()
			: base(2641)
		{
	...
	public class GSkill2642Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2642 : GSkill
	{
		public GSkill2642()
			: base(2642)
		{
	...
	public class GSkill2643Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2643 : GSkill
	{
		public GSkill2643()
			: base(2643)
		{
	...
	public class GSkill2644Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2644 : GSkill
	{
		public GSkill2644()
			: base(2644)
		{
	...
	public class GSkill2645Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2645 : GSkill
	{
		public GSkill2645()
			: base(2645)
		{
	...
	public class GSkill2646Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2646 : GSkill
	{
		public GSkill2646()
			: base(2646)
		{
	...
	public class GSkill2647Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState6 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetCrit(0.16f);
				skill.SetPlus((player_def * 1.5f + ((6 * (player_res5 + (player_res4 + (player_res3 + (player_res2 + player_res1))))))));
				player.SetPerform(0);
			}
		}
		public GSkill2647Stub()
			: base(2647)
		{
			occupation = 146;
			maxlevel = 1;
			...
			SetAction(10,"0");
			SetAction(11,"0");
			SetAction(12,"Ìì»ª_ÇÙÈĞ");
			SetAction(13,"");
			SetAction(14,"");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"Ìì»ª_Æï³Ë_ÇÙÈĞ");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
			...
			SetAction(28,"0");
			SetAction(29,"0");
			SetAction(30,"Ìì»ª_Æï³Ë_ÇÙÈĞ");
			name = "¹ØÉ½ÔÂ£ºÎä";
			nativename = "¹ØÉ½ÔÂ£ºÎä";
			icon = "¹ØÉ½ÔÂ.dds";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
	...
	public class GSkill2647 : GSkill
	{
		public GSkill2647()
			: base(2647)
		{
	...
	public class GSkill2648Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2648 : GSkill
	{
		public GSkill2648()
			: base(2648)
		{
	...
	public class GSkill2649Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2649 : GSkill
	{
		public GSkill2649()
			: base(2649)
		{
