...
namespace SKILL
{
	public class GSkill3020Stub : GSkillStub
	{
			...
			: base(3020)
		{
			...
			SetAction(30,"0");
			name = "Éñ½£ÓùÀ×Õæ¾÷<Ğş>";
			nativename = "Éñ½£ÓùÀ×Õæ¾÷<Ğş>";
			icon = "ÏÉ¡¤Éñ½£ÓùÀ×Õæ¾÷.dds";
			SetTalent(0,593);
			SetTalent(1,607);
			SetTalent(2,617);
			SetTalent(3,0);
	...
	public class GSkill3023Stub : GSkillStub
	{
			...
			: base(3023)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(1,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(2,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(3,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(4,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(5,"¹íÍõ×Ú_»ÙÌìÃğµØ");
			SetAction(6,"0");
			SetAction(7,"0");
			SetAction(8,"0");
			SetAction(9,"0");
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(19,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(20,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(21,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(22,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(23,"¹íÍõ×Ú_Æï³Ë_»ÙÌìÃğµØ");
			SetAction(24,"0");
			SetAction(25,"0");
			SetAction(26,"0");
			SetAction(27,"0");
	...
	public class GSkill3026Stub : GSkillStub
	{
			...
			: base(3026)
		{
			...
			SetAction(30,"0");
			name = "ÎŞÁ¿ÕæÑÔ<Ğş>";
			nativename = "ÎŞÁ¿ÕæÑÔ<Ğş>";
			icon = "ÏÉ¡¤ÎŞÁ¿ÕæÑÔ.dds";
			SetTalent(0,675);
			SetTalent(1,681);
			SetTalent(2,701);
			SetTalent(3,0);
	...
	public class GSkill3028Stub : GSkillStub
	{
			...
			: base(3028)
		{
			...
			SetAction(30,"0");
			name = "ÍòÏóÉú·ğ<Ğş>";
			nativename = "ÍòÏóÉú·ğ<Ğş>";
			icon = "ÏÉ¡¤ÍòÏóÉú·ğ.dds";
			SetTalent(0,697);
			SetTalent(1,703);
			SetTalent(2,719);
			SetTalent(3,0);
