...
namespace SKILL
{
	public class GSkill4930Stub : GSkillStub
	{
		public GSkill4930Stub()
			: base(4930)
		{
			occupation = 108;
			maxlevel = 10;
	...
	public class GSkill4930 : GSkill
	{
		public GSkill4930()
			: base(4930)
		{
	...
	public class GSkill4931Stub : GSkillStub
	{
	...
	public class GSkill4931 : GSkill
	{
		public GSkill4931()
			: base(4931)
		{
	...
	public class GSkill4932Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4932 : GSkill
	{
		public GSkill4932()
			: base(4932)
		{
	...
	public class GSkill4933Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio(4979.0f);
			victim.SetAmount(4979.0f);
			victim.SetValue(4979.0f);
	...
	public class GSkill4933 : GSkill
	{
		public GSkill4933()
			: base(4933)
		{
	...
	public class GSkill4934Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetRmhumanform(true);
			return true;
		}
	}
	public class GSkill4934 : GSkill
	{
		public GSkill4934()
			: base(4934)
		{
	...
	public class GSkill4935Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount(1.0f);
			victim.SetValue(60053.0f);
			victim.SetSummon(true);
			return true;
		}
	}
	public class GSkill4935 : GSkill
	{
		public GSkill4935()
			: base(4935)
		{
	...
	public class GSkill4936Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(4936)
		{
			...
			SetAction(1,"兽神_法宝_五色石");
			SetAction(2,"兽神_法宝_五色石");
			SetAction(3,"兽神_法宝_五色石");
			SetAction(4,"兽神_法宝_五色石");
			SetAction(5,"兽神_法宝_五色石");
			SetAction(6,"兽神_法宝_五色石");
			...
			SetAction(13,"灵夙_法宝_囚火灯");
			SetAction(14,"英招_法宝_囚火灯");
			SetAction(15,"武器大师_法宝_囚火灯");
			SetAction(16,"武器大师_法宝_囚火灯");
			SetAction(17,"归云_重伤");
			SetAction(18,"兽神_骑乘_法宝_五色石");
			SetAction(19,"兽神_骑乘_法宝_五色石");
			SetAction(20,"兽神_骑乘_法宝_五色石");
			SetAction(21,"兽神_骑乘_法宝_五色石");
			SetAction(22,"兽神_骑乘_法宝_五色石");
			SetAction(23,"兽神_骑乘_法宝_五色石");
			SetAction(24,"兽神_骑乘_法宝_五色石");
	...
	public class GSkill4936 : GSkill
	{
		public GSkill4936()
			: base(4936)
		{
	...
	public class GSkill4937Stub : GSkillStub
	{
		public GSkill4937Stub()
			: base(4937)
		{
			occupation = 130;
			maxlevel = 5;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((8 * skill_level + 30)));
			victim.SetTime(((2000 * skill_level + 8000)));
			victim.SetBuffid(1);
			victim.SetValue(((125 * skill_level)));
			victim.SetSubdefence(true);
			return true;
		}
	}
	public class GSkill4937 : GSkill
	{
		public GSkill4937()
			: base(4937)
		{
	...
	public class GSkill4938Stub : GSkillStub
	{
		public GSkill4938Stub()
			: base(4938)
		{
			occupation = 130;
			maxlevel = 5;
	...
	public class GSkill4938 : GSkill
	{
		public GSkill4938()
			: base(4938)
		{
	...
	public class GSkill4939Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill4939 : GSkill
	{
		public GSkill4939()
			: base(4939)
		{
