...
namespace SKILL
{
	public class GSkill5090Stub : GSkillStub
	{
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(((120 * norm(2))));
			victim.SetTime(3000.0f);
	...
	public class GSkill5090 : GSkill
	{
		public GSkill5090()
			: base(5090)
		{
	...
	public class GSkill5091Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5091 : GSkill
	{
		public GSkill5091()
			: base(5091)
		{
	...
	public class GSkill5092Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(46000.0f);
			victim.SetRatio(0.5f);
			victim.SetBuffid(140);
			victim.SetAmount(0.23999999f);
	...
	public class GSkill5092 : GSkill
	{
		public GSkill5092()
			: base(5092)
		{
	...
	public class GSkill5093Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(41000.0f);
			victim.SetRatio(1.25f);
			victim.SetBuffid(190);
			victim.SetAmount(0.13f);
	...
	public class GSkill5093 : GSkill
	{
		public GSkill5093()
			: base(5093)
		{
	...
	public class GSkill5094Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5094 : GSkill
	{
		public GSkill5094()
			: base(5094)
		{
	...
	public class GSkill5095Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5095 : GSkill
	{
		public GSkill5095()
			: base(5095)
		{
	...
	public class GSkill5096Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus((player_maxmp * 0.02f * 6.0f + 2000.0f));
				skill.SetCrithurt(0.1f);
				player.SetPerform(1);
			}
		}
		public GSkill5096Stub()
			: base(5096)
		{
			occupation = 128;
			maxlevel = 1;
	...
	public class GSkill5096 : GSkill
	{
		public GSkill5096()
			: base(5096)
		{
	...
	public class GSkill5097Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetProbability(240.0f);
			victim.SetTime(60000.0f);
			victim.SetRatio(0.04002f);
			victim.SetBuffid(1);
			victim.SetIncskilldodge(true);
			return true;
		}
	}
	public class GSkill5097 : GSkill
	{
		public GSkill5097()
			: base(5097)
		{
	...
	public class GSkill5098Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(0.0f);
			victim.SetRatio(5000.0f);
			victim.SetBuffid(0);
			victim.SetAmount(4000.0f);
	...
	public class GSkill5098 : GSkill
	{
		public GSkill5098()
			: base(5098)
		{
	...
	public class GSkill5099Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(4420.0f);
				player.SetPerform(1);
			}
		}
		public GSkill5099Stub()
			: base(5099)
		{
			occupation = 128;
			maxlevel = 1;
	...
	public class GSkill5099 : GSkill
	{
		public GSkill5099()
			: base(5099)
		{
