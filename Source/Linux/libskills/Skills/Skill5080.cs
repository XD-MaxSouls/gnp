...
namespace SKILL
{
	public class GSkill5080Stub : GSkillStub
	{
	...
	public class GSkill5080 : GSkill
	{
		public GSkill5080()
			: base(5080)
		{
	...
	public class GSkill5081Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState3 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				/*
				  ...
				  {
				skill.SetCrit((skill_charging * 0.0005f * 0.05f));
				  }
				player.SetVar1(1);
				  if ( skill_charging <= 0xFA )
				  {
				    skill.SetRatio(2.25f);
				  }
				  else
				  {
				skill.SetRatio((skill_charging * 0.0005f + 2.25f));
				  }
				skill.SetPlus(560.0f);
				player.SetPerform(1);
				*/
			}
			public override bool Cancel(GSkill skill)
		...
		public class GState5 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				/*
				  ...
				  {
				skill.SetCrit((skill_charging * 0.0005f * 0.05f + 0.1f));
				  }
				  if ( skill_charging <= 0xFA )
				  {
				    skill.SetRatio(2.25f);
	...
	public class GSkill5081 : GSkill
	{
		public GSkill5081()
			: base(5081)
		{
	...
	public class GSkill5082Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5082 : GSkill
	{
		public GSkill5082()
			: base(5082)
		{
	...
	public class GSkill5083Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5083 : GSkill
	{
		public GSkill5083()
			: base(5083)
		{
	...
	public class GSkill5084Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5084 : GSkill
	{
		public GSkill5084()
			: base(5084)
		{
	...
	public class GSkill5085Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5085 : GSkill
	{
		public GSkill5085()
			: base(5085)
		{
	...
	public class GSkill5086Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill5086 : GSkill
	{
		public GSkill5086()
			: base(5086)
		{
	...
	public class GSkill5087Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(5087)
		{
			...
			name = "ÉñÒý£ºÃ·»¨ÈýÅª";
			nativename = "ÉñÒý£ºÃ·»¨ÈýÅª";
			icon = "ÉñÒý£ºÃ·»¨ÈýÅª.dds";
			SetTalent(0,0);
			SetTalent(1,0);
			SetTalent(2,0);
			SetTalent(3,0);
	...
	public class GSkill5087 : GSkill
	{
		public GSkill5087()
			: base(5087)
		{
	...
	public class GSkill5088Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(5088)
		{
			...
			SetAction(10,"0");
			SetAction(11,"0");
			SetAction(12,"Ìì»ª_ÓñÔÏ");
			SetAction(13,"0");
			SetAction(14,"0");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"Ìì»ª_Æï³Ë_ÓñÔÏ");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(22000.0f);
			victim.SetRatio(0.75f);
			victim.SetDecdamage(true);
			victim.SetProbability(71.0f);
			victim.SetTime(((2000 * norm(2) + 22000)));
			victim.SetRatio(1.0f);
			victim.SetSkillmirror(true);
			return true;
		}
	}
	public class GSkill5088 : GSkill
	{
		public GSkill5088()
			: base(5088)
		{
	...
	public class GSkill5089Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
			...
			: base(5089)
		{
			...
			SetAction(10,"0");
			SetAction(11,"0");
			SetAction(12,"Ìì»ª_ÁìÓò_Ñô´º°×Ñ©");
			SetAction(13,"0");
			SetAction(14,"0");
			SetAction(15,"");
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"Ìì»ª_ÁìÓò_Ñô´º°×Ñ©");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill5089 : GSkill
	{
		public GSkill5089()
			: base(5089)
		{
