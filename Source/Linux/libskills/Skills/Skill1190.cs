...
namespace SKILL
{
	public class GSkill1190Stub : GSkillStub
	{
	...
	public class GSkill1190 : GSkill
	{
		public GSkill1190()
			: base(1190)
		{
	...
	public class GSkill1191Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1191 : GSkill
	{
		public GSkill1191()
			: base(1191)
		{
	...
	public class GSkill1192Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetRatio((skill_level * 0.005f + 1.0f));
				player.SetPerform(1);
			}
		}
		public GSkill1192Stub()
			: base(1192)
		{
			occupation = 128;
			maxlevel = 500;
	...
	public class GSkill1192 : GSkill
	{
		public GSkill1192()
			: base(1192)
		{
	...
	public class GSkill1193Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(2);
			victim.SetAmount(((100 * skill_level + player_maxhp - 6000)));
			victim.SetValue(1500.0f);
			victim.SetHpleak(true);
			return true;
		}
	}
	public class GSkill1193 : GSkill
	{
		public GSkill1193()
			: base(1193)
		{
	...
	public class GSkill1194Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1194 : GSkill
	{
		public GSkill1194()
			: base(1194)
		{
	...
	public class GSkill1195Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount(((player_maxmp - player_mp)));
	...
	public class GSkill1195 : GSkill
	{
		public GSkill1195()
			: base(1195)
		{
	...
	public class GSkill1196Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1196 : GSkill
	{
		public GSkill1196()
			: base(1196)
		{
	...
	public class GSkill1197Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(3);
			victim.SetAmount((player_maxhp * 0.75f));
			victim.SetValue(0.0f);
			victim.SetHpleak(true);
			victim.SetProbability(80.0f);
			victim.SetTime(((1000 * skill_level)));
	...
	public class GSkill1197 : GSkill
	{
		public GSkill1197()
			: base(1197)
		{
	...
	public class GSkill1198Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(3);
			victim.SetAmount((player_maxhp * 0.1f));
			victim.SetValue(0.0f);
			victim.SetHpgen(true);
			return true;
		}
	}
	public class GSkill1198 : GSkill
	{
		public GSkill1198()
			: base(1198)
		{
	...
	public class GSkill1199Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1199 : GSkill
	{
		public GSkill1199()
			: base(1199)
		{
