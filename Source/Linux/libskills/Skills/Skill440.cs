...
namespace SKILL
{
	...
	public class GSkill441Stub : GSkillStub
	{
			...
			: base(441)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"鬼王宗_众志成城");
			SetAction(1,"青云门_众志成城");
			SetAction(2,"鬼王宗_众志成城");
			SetAction(3,"合欢派_众志成城");
			SetAction(4,"天音寺_众志成城");
			SetAction(5,"合欢派_众志成城");
			SetAction(6,"焚香谷_众志成城");
			SetAction(7,"兽神_众志成城");
			SetAction(8,"狐妖_众志成城");
			SetAction(9,"轩辕_众志成城");
			SetAction(10,"怀光_众志成城");
			SetAction(11,"太昊_众志成城");
			SetAction(12,"天华_众志成城");
			SetAction(13,"灵夙_众志成城");
			SetAction(14,"英招_众志成城");
			SetAction(15,"武器大师_众志成城");
			SetAction(16,"元素大师_众志成城");
			SetAction(17,"天音寺_众志成城");
			SetAction(18,"鬼王宗_骑乘_众志成城");
			SetAction(19,"青云门_骑乘_众志成城");
			SetAction(20,"鬼王宗_骑乘_众志成城");
			SetAction(21,"合欢派_骑乘_众志成城");
			SetAction(22,"天音寺_骑乘_众志成城");
			SetAction(23,"合欢派_骑乘_众志成城");
			SetAction(24,"焚香谷_骑乘_众志成城");
			SetAction(25,"兽神_骑乘_众志成城");
			SetAction(26,"狐妖_骑乘_众志成城");
			SetAction(27,"轩辕_骑乘_众志成城");
			SetAction(28,"怀光_骑乘_众志成城");
			SetAction(29,"太昊_骑乘_众志成城");
			SetAction(30,"天华_骑乘_众志成城");
			name = "众志成城";
			nativename = "众志成城";
			icon = "众志成城.dds";
			SetTalent(0,1714);
	...
	public class GSkill442Stub : GSkillStub
	{
			...
			: base(442)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"鬼王宗_同生共死");
			SetAction(1,"青云门_同生共死");
			SetAction(2,"鬼王宗_同生共死");
			SetAction(3,"合欢派_同生共死");
			SetAction(4,"天音寺_同生共死");
			SetAction(5,"合欢派_同生共死");
			SetAction(6,"焚香谷_同生共死");
			SetAction(7,"兽神_同生共死");
			SetAction(8,"狐妖_同生共死");
			SetAction(9,"轩辕_同生共死");
			SetAction(10,"怀光_同生共死");
			SetAction(11,"太昊_同生共死");
			SetAction(12,"天华_同生共死");
			SetAction(13,"灵夙_同生共死");
			SetAction(14,"英招_同生共死");
			SetAction(15,"武器大师_同生共死");
			SetAction(16,"元素大师_同生共死");
			SetAction(17,"天音寺_同生共死");
			SetAction(18,"青云门_骑乘_同生共死");
			SetAction(19,"青云门_骑乘_同生共死");
			SetAction(20,"鬼王宗_骑乘_同生共死");
			SetAction(21,"合欢派_骑乘_同生共死");
			SetAction(22,"天音寺_骑乘_同生共死");
			SetAction(23,"合欢派_骑乘_同生共死");
			SetAction(24,"焚香谷_骑乘_同生共死");
			SetAction(25,"兽神_骑乘_同生共死");
			SetAction(26,"狐妖_骑乘_同生共死");
			SetAction(27,"轩辕_骑乘_同生共死");
			SetAction(28,"怀光_骑乘_同生共死");
			SetAction(29,"太昊_骑乘_同生共死");
			SetAction(30,"天华_骑乘_同生共死");
			name = "同生共死";
			nativename = "同生共死";
			icon = "同生共死.dds";
			SetTalent(0,1714);
	...
	public class GSkill443Stub : GSkillStub
	{
			...
			: base(443)
		{
			...
			item_relation = 0;
			weapon_limit = -1;
			SetAction(0,"鬼王宗_群策群力");
			SetAction(1,"青云门_群策群力");
			SetAction(2,"鬼王宗_群策群力");
			SetAction(3,"合欢派_群策群力");
			SetAction(4,"天音寺_群策群力");
			SetAction(5,"合欢派_群策群力");
			SetAction(6,"焚香谷_群策群力");
			SetAction(7,"兽神_群策群力");
			SetAction(8,"狐妖_群策群力");
			SetAction(9,"轩辕_群策群力");
			SetAction(10,"怀光_群策群力");
			SetAction(11,"太昊_群策群力");
			SetAction(12,"天华_群策群力");
			SetAction(13,"灵夙_群策群力");
			SetAction(14,"英招_群策群力");
			SetAction(15,"武器大师_群策群力");
			SetAction(16,"元素大师_群策群力");
			SetAction(17,"天音寺_群策群力");
			SetAction(18,"鬼王宗_骑乘_群策群力");
			SetAction(19,"青云门_骑乘_群策群力");
			SetAction(20,"鬼王宗_骑乘_群策群力");
			SetAction(21,"合欢派_骑乘_群策群力");
			SetAction(22,"天音寺_骑乘_群策群力");
			SetAction(23,"合欢派_骑乘_群策群力");
			SetAction(24,"焚香谷_骑乘_群策群力");
			SetAction(25,"兽神_骑乘_群策群力");
			SetAction(26,"狐妖_骑乘_群策群力");
			SetAction(27,"轩辕_骑乘_群策群力");
			SetAction(28,"怀光_骑乘_群策群力");
			SetAction(29,"太昊_骑乘_群策群力");
			SetAction(30,"天华_骑乘_群策群力");
			name = "群策群力";
			nativename = "群策群力";
			icon = "群策群力.dds";
			SetTalent(0,1714);
