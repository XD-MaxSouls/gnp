...
namespace SKILL
{
	public class GSkill1060Stub : GSkillStub
	{
	...
	public class GSkill1060 : GSkill
	{
		public GSkill1060()
			: base(1060)
		{
	...
	public class GSkill1061Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(0);
			victim.SetAmount((player_maxmp * 0.5f + 1.0f));
			victim.SetValue(((player_maxmp - player_mp)));
			victim.SetSubmp(true);
			return true;
		}
	}
	public class GSkill1061 : GSkill
	{
		public GSkill1061()
			: base(1061)
		{
	...
	public class GSkill1062Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1062 : GSkill
	{
		public GSkill1062()
			: base(1062)
		{
	...
	public class GSkill1063Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1063 : GSkill
	{
		public GSkill1063()
			: base(1063)
		{
	...
	public class GSkill1064Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1064 : GSkill
	{
		public GSkill1064()
			: base(1064)
		{
	...
	public class GSkill1065Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetBuffid(1);
			victim.SetAmount((((100 * player_maxhp)) / (player_hp + 1000.0f)));
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetValue((player_maxhp * (skill_level * 0.002f)));
			victim.SetHeal(true);
			return true;
		}
	}
	public class GSkill1065 : GSkill
	{
		public GSkill1065()
			: base(1065)
		{
	...
	public class GSkill1066Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1066 : GSkill
	{
		public GSkill1066()
			: base(1066)
		{
	...
	public class GSkill1067Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetTime(8000.0f);
			victim.SetBuffid(0);
			victim.SetAmount((player_mp * (skill_level * 0.02f)));
			victim.SetValue(0.0f);
			victim.SetMpleak(true);
			victim.SetProbability(100.0f);
			victim.SetTime(8000.0f);
	...
	public class GSkill1067 : GSkill
	{
		public GSkill1067()
			: base(1067)
		{
	...
	public class GSkill1068Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill1068 : GSkill
	{
		public GSkill1068()
			: base(1068)
		{
	...
	public class GSkill1069Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetRatio((skill_level * 0.01f));
			victim.SetAmount(0.0f);
			victim.SetValue((skill_level * 0.01f));
			victim.SetSecondattack(true);
			victim.SetProbability(100.0f);
			victim.SetTime(16000.0f);
			victim.SetBuffid(0);
			...
			victim.SetTime(200.0f);
			victim.SetBuffid(2);
			victim.SetAmount((player_maxhp * (skill_level * 0.005f)));
			victim.SetValue(0.0f);
			victim.SetHpleak(true);
			return true;
		}
	}
	public class GSkill1069 : GSkill
	{
		public GSkill1069()
			: base(1069)
		{
