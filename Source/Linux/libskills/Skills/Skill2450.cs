...
namespace SKILL
{
	public class GSkill2450Stub : GSkillStub
	{
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetRatio((skill_t1 * 0.1f + v13));
				skill.SetPlus(((10 * skill_level + 277)));
				player.SetPerform(1);
				*/
			}
		}
		public GSkill2450Stub()
			: base(2450)
		{
			occupation = 49;
			maxlevel = 6;
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			{
			d = (skill_level * player_var1 / 5 + player_var1);
			}
	...
	public class GSkill2450 : GSkill
	{
		public GSkill2450()
			: base(2450)
		{
	...
	public class GSkill2451Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				v21 = skill_t1 * (skill_c0 * 0.08f) + ((0.05f * skill_level) + 1.05f);
				if ( skill_t2 < skill_t3 )
				  {
				if ( skill_t3 < skill_t4 )
				      v18 = skill_t4 * 0.012f + v21;
				    else
				v20 = (skill_t3 * 0.012f + v21);
				  }
				  else
				  {
				if ( skill_t2 < skill_t4 )
				      v19 = skill_t4 * 0.012f + v21;
				    else
				v20 = (skill_t2 * 0.012f + v21);
				  }
				skill.SetRatio(v20);
				skill.SetPlus((skill_t0 * (player_hp * 0.05f) + ((10 * skill_level + 244))));
				player.SetHp(((1.0f - skill_t0 * 0.05f) * player_hp));
				player.SetPerform(1);
				*/
			}
		}
		public GSkill2451Stub()
			: base(2451)
		{
			occupation = 49;
			maxlevel = 3;
	...
	public class GSkill2451 : GSkill
	{
		public GSkill2451()
			: base(2451)
		{
	...
	public class GSkill2452Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2452 : GSkill
	{
		public GSkill2452()
			: base(2452)
		{
	...
	public class GSkill2453Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetTime(((5000 * skill_t0 + 30000)));
	...
	public class GSkill2453 : GSkill
	{
		public GSkill2453()
			: base(2453)
		{
	...
	public class GSkill2454Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool StateAttack(GSkill skill)
		{
			...
			victim.SetHeal(true);
			victim.SetProbability(zrand(80));
			victim.SetTime(60000.0f);
			victim.SetBuffid(2);
	...
	public class GSkill2454 : GSkill
	{
		public GSkill2454()
			: base(2454)
		{
	...
	public class GSkill2455Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetAmount(99999.0f);
			victim.SetValue(10.0f);
			victim.SetAshill(true);
			return true;
		}
	}
	public class GSkill2455 : GSkill
	{
		public GSkill2455()
			: base(2455)
		{
	...
	public class GSkill2456Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public override bool BlessMe(GSkill skill)
		{
			...
			victim.SetProbability(120.0f);
			victim.SetAmount(1.2f);
			victim.SetValue(0.1f);
			victim.SetLongxiang(true);
			return true;
		}
	}
	public class GSkill2456 : GSkill
	{
		public GSkill2456()
			: base(2456)
		{
	...
	public class GSkill2457Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2457 : GSkill
	{
		public GSkill2457()
			: base(2457)
		{
	...
	public class GSkill2458Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
	...
	public class GSkill2458 : GSkill
	{
		public GSkill2458()
			: base(2458)
		{
	...
	public class GSkill2459Stub : GSkillStub
	{
		public class GState1 : GState
		{
			public override int GetTime(GSkill skill)
		...
		public class GState2 : GState
		{
			...
			public override void Calculate(GSkill skill)
			{
				...
				skill.SetPlus(((5 * skill_t0 * skill_level + ((20 * skill_level + 50) * norm(30 / player_level) + (5 * skill_level)) + 20)));
				player.SetPerform(1);
			}
		}
		public GSkill2459Stub()
			: base(2459)
		{
			occupation = 51;
			maxlevel = 10;
			...
			SetAction(16,"");
			SetAction(17,"");
			SetAction(18,"Ìì»ª_Æï³Ë_³õÔªÒôÈÐ");
			SetAction(19,"0");
			SetAction(20,"0");
			SetAction(21,"0");
			SetAction(22,"0");
	...
	public class GSkill2459 : GSkill
	{
		public GSkill2459()
			: base(2459)
		{
